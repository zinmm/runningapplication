...
package com.zin.ra.processes.models;
...
public class AndroidAppProcess extends AndroidProcess
{
	...
	{
		super(pid);
		if (name == null || !PROCESS_NAME_PATTERN.matcher(name).matches() || !new File("/data/data", getPackageName()).exists())
		{
		...
		if (SYS_SUPPORTS_SCHEDGROUPS)
		{
			...
			if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
			{
				...
				AndroidProcesses.log("name=%s, pid=%d, uid=%d, foreground=%b, cpuacct=%s, cpu=%s", name, pid, uid, foreground, cpuacct.toString(),
						cpu.toString());
			}
			else
			{
	 ...
	 * @param flags
	 *            Additional option flags. Use any combination of {@link PackageManager#GET_ACTIVITIES}, {@link PackageManager#GET_GIDS},
	 *            {@link PackageManager#GET_CONFIGURATIONS}, {@link PackageManager#GET_INSTRUMENTATION}, {@link PackageManager#GET_PERMISSIONS},
	 *            {@link PackageManager#GET_PROVIDERS}, {@link PackageManager#GET_RECEIVERS}, {@link PackageManager#GET_SERVICES},
	 *            {@link PackageManager#GET_SIGNATURES}, {@link PackageManager#GET_UNINSTALLED_PACKAGES} to modify the data returned.
